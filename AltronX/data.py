RAID = [
    ...
    "November me lagti h sab ko thand teri maa ke bhosde me  ghusa h #chaccha ka lund🍆🍆🖕👅👅",
    "Gaand ka makhan- Butter from the ass",
    "Teri mummy ki chut pe Chad ke 200000 ka group bnAo ga",
    "MAI MARUGA MAR JAYEGA DUBARA ZANAM LENE SE  DAR JAYEGA😎💪😈🔥👊",
